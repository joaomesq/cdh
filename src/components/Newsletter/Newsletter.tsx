...
export default function Newsletter({email}: NewsletterProps){
    return (
        <div className='bg-orange-300 shadow-lg rounded-xl p-8 max-w-4xl w-full text-center'>
            <div>
            ...
            <div>
                <form action={`https://formsubmit.co/${email}`} method='POST' className='flex flex-col sm:flex-row items-center gap-2'>
                    ...
                    <button type='submit' className='bg-orange-400 text-white font-semibold p-2 rounded-lg hover:bg-blue-700 transition w-full sm:w-auto'>Inscrever-se</button>
                </form>
