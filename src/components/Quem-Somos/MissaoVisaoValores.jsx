  ...
  return (
    <section id="missao" className="p-4 py-12">
      ...
      <div className="mt-12 mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 rounded-lg border-l-4 border-cdh-pink/90 bg-white/50 hover:shadow-lg">
        ...
        <div className="p-4 rounded-lg border-l-4 border-cdh-teal bg-white/50 hover:shadow-lg">
        ...
        <div className="p-4 rounded-lg border-l-4 border-cdh-orange bg-white/50 hover:shadow-lg">
